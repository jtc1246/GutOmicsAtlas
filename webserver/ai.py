...
3. def enrichment(pathway: str, cell_type: str): -> bytes:
    ...
    1. "Pro-inflammatory", have cell_type "Fibroblast", "Smooth muscle cell"
...
client = OpenAI(api_key="")  # set your API key here
...
def check_format(resp: str) -> Tuple[bool, str]:
    ...
    for msg in resp:
        ...
        if (func_name not in ['fov_image', 'gene_expression', 'enrichment', 'differential_exp']):
